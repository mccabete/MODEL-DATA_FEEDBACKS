...
Plotting cogongrass uncertainties from meta-analysis, field-work, and PDA. This relies on installing the PEcAn packages. This script ahs been tested using R version 4.4.0. See instructions for installation see the [PEcAn documentation](https://pecanproject.github.io/documentation). This script also relies on the PEcAn.ED2 package. 
...
source("plot_variance_decomposition_comparison.R")
...
#load("/fs/data2/output//PEcAn_1000020051/sensitivity.results.NOENSEMBLEID.LAI.2013.2019.Rdata") ## ON SCC
load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000020051/sensitivity.results.NOENSEMBLEID.LAI.2013.2019.Rdata")
...
load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000020054/sensitivity.results.NOENSEMBLEID.LAI.2013.2019.Rdata")
...
load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000020678/sensitivity.results.NOENSEMBLEID.LAI.2013.2019.Rdata")
#load("/fs/data2/output//PEcAn_1000020678/sensitivity.results.NOENSEMBLEID.LAI.2013.2019.Rdata")
post_pf <- sensitivity.results
#output_post_pf <- sensitivity.output
rm(sensitivity.results)
# rm(sensitivity.output)
...
## IF GET ERROR, make sure only dplyr is loaded in function itself.
...
## Varience Decomposition Plots (Figures 3, 4, 5)
```{r}
#paths <- c("/fs/data2/output//PEcAn_1000020054/", "/fs/data2/output//PEcAn_1000020051/", "/fs/data2/output//PEcAn_1000020678/") ## Paths to runs
paths <- c("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020054/", "/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020051/", "/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020678/") ## Paths to runs
wd = getwd()
output_vars <- c("LAI", "TVeg", "NPP")
save_path <- paste0(wd, "/plots")
...
### Function to get overall uncertainty per varible, Figure 7
```{r}
...
# lai <- c()
# for(i in 2013:2019){
#   nc <- ncdf4::nc_open(paste0("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020678/out/1003228043/", i, ".nc"))
...
# ```
# 
# ### Initial attempt at plots of uncertainty in LAI ## I TENTATIVELY THINK THIS IS REDUNDANT WITH ABOVE CODE. COMMENTING OUT AS TRIAL
# ```{r}
# 
# 
...
#   
# 
# # load(paste0("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000018829/sensitivity.results.1000033035.", output_vars[i], ".2013.2019.Rdata"))
# # load(paste0("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000018829/sensitivity.output.1000033035.", output_vars[i], ".2013.2019.Rdata"))
# # bivens_ambient <- sensitivity.results
# # output_pre_feild <- sensitivity.output
# # rm(sensitivity.output)
# # rm(sensitivity.results)
# 
# # load(paste0("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000018777/sensitivity.results.1000033014.", output_vars[i],".2013.2019.Rdata"))
# # load(paste0("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000018777/sensitivity.output.1000033014.", output_vars[i],".2013.2019.Rdata"))
# # output_pre_feild <- sensitivity.output
# # bivens_pre_field <- sensitivity.results
# # rm(sensitivity.output)
# # rm(sensitivity.results)
...
# # load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000018924/pft/cogongrass2/post.distns.MA.Rdata")
# # 
# # MA_post <- post.distns
# # rm(post.distns)
# 
# # load("/fs/data2/output/PEcAn_1000018924/pft/cogongrass2/prior.distns.Rdata")
# # #load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000018878/pft/cogongrass2/prior.distns.Rdata") ## FROM SHORT RUN
# # MA_prior <- prior.distns
# # rm(prior.distns)

load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000018777/pft/sudoCogongrass2/prior.distns.Rdata")
MA_pre_prior <- prior.distns

load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000018829/pft/cogongrass2/post.distns.MA.Rdata")
MA_post_field <- post.distns
# 
# #load("projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_PDA_50_knots/pft/cogongrass2/post.distns.pda.cogongrass2_PDA_50kn_MODEL_REDO.Rdata")
# #load("projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000018924/pft/cogongrass2/post.distns.pda.cogongrass2_PDA_VIGNETTE_TEST.Rdata")
# # load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_50_knots_local/pft/cogongrass2/post.distns.pda.cogongrass2_PDA_50kn_MODEL_REDO.Rdata")
# # pda_post <- post.distns
# # rm(post.distns)
# 
# grid.arrange(test_three$trait.plot, test_three$cv.plot, test_three$pv.plot, test_three$el.plot, nrow = 1)
```
Note: I ran the PDA with the MA_prior as my prior. This doesn't make a difference, because I ran the PDA on water_conductance and growth_respiration, which didnt have any data associated with them. (if you look at MA pre and MA post, the distn, parama and param b are identical for water conductance and growth respiration). It does mean that to incorporate both calibrations, I need to combine the water conductance + growth resp constraint and the other traits constraint into one object. 
...
# attach("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000018924/pft/cogongrass2/PDA_MA_post.Rdata")
# post_pda <- combined_posteriors
# rm(combined_posteriors)

load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_PDA_for_PF/pft/cogongrass2/PDA_MA_post.Rdata")
...
## Plotting constraint from PDA, redundant with plots in Check of Log Likelyhood. 
```{r}
# 
...
load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000020678/pft/cogongrass2/prior.distns.Rdata") ## FROM SHORT RUN
MA_prior <- prior.distns
rm(prior.distns)
...
## Growth Respiration
growth_resp_prior <- quantile(rbeta(700000,MA_prior$parama[2], MA_prior$paramb[2]), probs = c(0.025, 0.975))
growth_resp_post <-  quantile(rbeta(700000,pda_post$parama[2], pda_post$paramb[2]), probs = c(0.025, 0.975))
growth_reduction <- (growth_resp_prior[2] - growth_resp_prior[1]) / (growth_resp_post[2] - growth_resp_post[1])

plot(density(rbeta(100000,pda_post$parama[2], pda_post$paramb[2])), main = "Growth Respiration Factor", col =  "#7570b3", sub = paste("A", round(growth_reduction, 2), "fold decrease in 95% CI"))
lines(density(rbeta(100000,MA_post$parama[2], MA_post$paramb[2])), col = "#2CBEC5")



wat_con_prior <- quantile(log(rlnorm(100000,MA_prior$parama[10], MA_prior$paramb[10])), probs = c(0.025, 0.975))
#wat_con_post <- quantile(rgamma(100000,pda_post$parama[10], pda_post$paramb[10]), probs = c(0.025, 0.975), na.rm = TRUE)

wat_con_post <- quantile(log(rlnorm(100000,pda_post$parama[10], pda_post$paramb[10])), probs = c(0.025, 0.975), na.rm = TRUE)

wat_con_red <- (wat_con_prior[2] - wat_con_prior[1])/ (wat_con_post[2] - wat_con_post[1])

## Water Conductance
plot(density(log(rlnorm(100000,pda_post$parama[10], pda_post$paramb[10]))), main = " Log-scale Water Conductance Factor", col = "#7570b3", sub = paste("A", round(wat_con_red, 4), "fold decrease in 95% CI"))
lines(density(log(rlnorm(100000,MA_prior$parama[10], MA_prior$paramb[10]))), col = "#2CBEC5" )
#lines(density(log(rlnorm(1000, lit_onlt$parama[10], lit_onlt$paramb[10]))), col = "#F47769")


### Plotting Directly from mcmc
# load("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan/PEcAn_1000018924/pft/cogongrass2/mcmc.pda.cogongrass2_PDA_VIGNETTE_TEST.Rdata")
...
## ggridges prior plotting Figure 6
...
## Getting a sensitivity analysis with both new priors included I THINK THIS IS WORTH EXCLUDING
```{r}
...
# #sudo chmod -R 777 /projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020678/out
#  outfile <- "/projectnb/dietzelab/pecan.data/output//tmccabe/1000020678/out/"
#  run_ids <- list.files(outfile)
# 
#  pfts <- list()
...
# for( i in seq_along(run_ids)){
#    file_path <- paste(outfile,"/", run_ids[i],"/t_files", sep = "")
#    test_pecan_path <- paste0("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020678/out/", run_ids[i], "/")
#   system(paste0("cp ", file_path, "/*.nc ", test_pecan_path))
# 
# 
# }
# settings <- read.settings("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020678/pecan.CHECKED.xml")  ## Post PF + feild work sensitivity
...
# #  pfts$pft$name <- "cogongrass2"
# #  
# # #sudo chmod -R 777 /projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan///PEcAn_1000020051/
# # for( i in seq_along(run_ids)){
# #    file_path <- paste(outfile,"/", run_ids[i],"/t_files", sep = "")
# #    test_pecan_path <- paste0("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020051/out/", run_ids[i], "/")
# #    system(paste0("mkdir ", test_pecan_path))
# #   system(paste0("cp ", file_path, "/*.nc ", test_pecan_path))
# # 
# # 
# # }
# # settings <- read.settings("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020051/pecan.CHECKED.xml")  ## Post PF + feild work sensitivity
# # #settings_not_fs <- settings
# # #settings_not_fs$modeloutdir <- settings$host$outdir
# # #get.results(settings = settings_not_fs)
# # 
...
# #  
# # #sudo chmod -R 777 /projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020054/
# # for( i in seq_along(run_ids)){
# #    file_path <- paste(outfile,"/", run_ids[i],"/t_files", sep = "")
# #    test_pecan_path <- paste0("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020054/out/", run_ids[i], "/")
# #    #system(paste0("mkdir ", test_pecan_path))
# #   system(paste0("cp ", file_path, "/*.nc ", test_pecan_path))
# # 
# # 
# # }
# # settings <- read.settings("/projectnb/dietzelab/pecan.data/output/tmccabe/model_data_feedbacks/test_pecan//PEcAn_1000020054/pecan.CHECKED.xml")  ## Post PF + feild work sensitivity
# # #settings_not_fs <- settings
# # #settings_not_fs$modeloutdir <- settings$host$outdir
# # #get.results(settings = settings_not_fs)
# # 
...
# DOuble checking LAI values. I THINK THIS IS WORTH EXCLUDING

I noticed that with constraint, the LAI values appeared to go down. I through this was weird, because I am modeling a grass. Here I look at the plotted versions of the LAI values, from the post field data runs
